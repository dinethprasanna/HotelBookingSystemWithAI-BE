...
var retrieve = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var query, hotels, embeddingsModel, vectorIndex, results, matchedHotels, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                hotels = (_a.sent()).map(function (hotel) { return ({
                    hotel: hotel,
                    confidence: 1,
                }); });
            ...
            case 3:
                results = _a.sent();
                console.log(results);
                return [4 /*yield*/, Promise.all(results.map(function (result) { return __awaiter(void 0, void 0, void 0, function () {
                        var hotel;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
            ...
            case 4:
                ...
                res
                    .status(200)
                    .json(matchedHotels.length > 2 ? matchedHotels.slice(0, 3) : matchedHotels);
                return [2 /*return*/];
            case 5:
                error_1 = _a.sent();
                next(error_1);
