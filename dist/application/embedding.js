...
var createEmbeddings = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var embeddingsModel, vectorIndex, hotels, docs, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                hotels = _a.sent();
                docs = hotels.map(function (hotel) {
                    var _id = hotel._id, location = hotel.location, price = hotel.price, description = hotel.description;
                    var doc = new documents_1.Document({
                ...
                return [4 /*yield*/, vectorIndex.addDocuments(docs)];
            case 2:
                _a.sent();
                res.status(200).json({
